...
class BinaryStrOperationTests(BinaryOperationTestCase, TranspileTestCase):
    ...
    not_implemented = [
        ...
        'test_direct_modulo_bool',
        'test_direct_modulo_bytes',
        'test_direct_modulo_bytearray',
        'test_direct_modulo_class',
        'test_direct_modulo_complex',
        'test_direct_modulo_dict',
        'test_direct_modulo_float',
        'test_direct_modulo_frozenset',
        'test_direct_modulo_slice',
        'test_direct_modulo_int',
        'test_direct_modulo_list',
        'test_direct_modulo_None',
        'test_direct_modulo_NotImplemented',
        'test_direct_modulo_range',
        'test_direct_modulo_set',
